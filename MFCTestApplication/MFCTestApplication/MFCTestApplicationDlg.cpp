...
// MFCTestApplicationDlg.cpp : implementation file
//
...
// CMFCTestApplicationDlg message handlers
...
void CMFCTestApplicationDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCTestApplicationDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CMFCTestApplicationDlg::OnQueryDragIcon()
{
